...
class PemeriksaanRequest extends FormRequest
{
    ...
    {
        // validasi data npwp, nama_wp, nomor_sp2, nomor_sp2_perubahan, nomor_nd_perpanjangan, tanggal_sp2, tanggal_sp2_perubahan, tanggal_penyampaian_sp2, tanggal_jatuh_tempo_sp2, kode_pemeriksaan, kriteria_pemeriksaan, nilai_potensi int, ketua_tim, anggota_1, anggota_2, anggota_3, masa_pajak_start, masa_pajak_end
        return [
            ...
            'nomor_nd_perpanjangan' => 'required|max:255',
