...
class CreatePemeriksaansTable extends Migration
{
    ...
    public function up()
    {
        // buat table pemeriksaan dengan kolom npwp, nama_wp, nomor_sp2, nomor_sp2_perubahan, nomor_nd_perpanjangan, tanggal_sp2 date, tanggal_sp2_perubahan date, tanggal_penyampaian_sp2 date, tanggal_jatuh_tempo_sp2 date,kode_pemeriksaan, kriteria_pemeriksaan set(rutin, khusus, tujuan_lain), nilai_potensi int, ketua_tim retasi, anggota_1, anggota_2, anggota_3, masa_pajak_start date, masa_pajak_end date
        Schema::create('pemeriksaans', function (Blueprint $table) {
            ...
            $table->string('nomor_nd_perpanjangan');
