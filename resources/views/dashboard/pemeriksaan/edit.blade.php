...
@section('content')
    <div class="container-fluid">
        <div class="row mb-3 mb-lg-4">
            <div class="col-auto">
                <h3><strong>Pemeriksaan</strong> Ubah</h3>
            </div>
        ...
        <form id="form" action="{{ route('pemeriksaan.update', $pemeriksaan->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('npwp') is-invalid @enderror" name="npwp"
                                value="{{ old('npwp', $pemeriksaan->npwp) }}" placeholder="NPWP">
                            @error('npwp')
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_wp') is-invalid @enderror" name="nama_wp"
                                value="{{ old('nama_wp', $pemeriksaan->nama_wp) }}" placeholder="Nama WP">
                            @error('nama_wp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_sp2') is-invalid @enderror"
                                name="nomor_sp2" value="{{ old('nomor_sp2', $pemeriksaan->nomor_sp2) }}">
                            @error('nomor_sp2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_sp2') is-invalid @enderror"
                                name="tanggal_sp2" value="{{ old('tanggal_sp2', $pemeriksaan->tanggal_sp2) }}">
                            @error('tanggal_sp2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_sp2_perubahan') is-invalid @enderror"
                                name="nomor_sp2_perubahan"
                                value="{{ old('nomor_sp2_perubahan', $pemeriksaan->nomor_sp2_perubahan) }}">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_sp2_perubahan') is-invalid @enderror"
                                name="tanggal_sp2_perubahan"
                                value="{{ old('tanggal_sp2_perubahan', $pemeriksaan->tanggal_sp2_perubahan) }}">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_nd_perpanjangan') is-invalid @enderror"
                                name="nomor_nd_perpanjangan"
                                value="{{ old('nomor_nd_perpanjangan', $pemeriksaan->nomor_nd_perpanjangan) }}">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_penyampaian_sp2') is-invalid @enderror"
                                name="tanggal_penyampaian_sp2"
                                value="{{ old('tanggal_penyampaian_sp2', $pemeriksaan->tanggal_penyampaian_sp2) }}">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('kode_pemeriksaan') is-invalid @enderror"
                                ...
                                value="{{ old('kode_pemeriksaan', $pemeriksaan->kode_pemeriksaan) }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select class="form-control mb-3" name="kriteria_pemeriksaan">
                                <option value="rutin"
                                    {{ old('kriteria_pemeriksaan', $pemeriksaan->kriteria_pemeriksaan) == 'rutin' ? 'selected' : '' }}>
                                    Rutin
                                </option>
                                <option value="khusus"
                                    {{ old('kriteria_pemeriksaan', $pemeriksaan->kriteria_pemeriksaan) == 'khusus' ? 'selected' : '' }}>
                                    Khusus
                                </option>
                                <option value="tujuan_lain"
                                    {{ old('kriteria_pemeriksaan', $pemeriksaan->kriteria_pemeriksaan) == 'tujuan_lain' ? 'selected' : '' }}>
                                    Tujuan Lain
                                </option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('nilai_potensi') is-invalid @enderror"
                                name="nilai_potensi" value="{{ old('nilai_potensi', $pemeriksaan->nilai_potensi) }}">
                            @error('nilai_potensi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="date"
                                            ...
                                            name="masa_pajak_start"
                                            value="{{ old('masa_pajak_start', $pemeriksaan->masa_pajak_start) }}">
                                    ...
                                    <div class="col">
                                        <input type="date"
                                            ...
                                            name="masa_pajak_end"
                                            value="{{ old('masa_pajak_end', $pemeriksaan->masa_pajak_end) }}">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('ketua_tim') is-invalid @enderror"
                                    name="ketua_tim" value="{{ old('ketua_tim', $pemeriksaan->ketua_tim) }}">
                                @error('ketua_tim')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('anggota_1') is-invalid @enderror"
                                    name="anggota_1" value="{{ old('anggota_1', $pemeriksaan->anggota_1) }}">
                                @error('anggota_1')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('anggota_2') is-invalid @enderror"
                                    name="anggota_2" value="{{ old('anggota_2', $pemeriksaan->anggota_2) }}">
                                @error('anggota_2')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('anggota_3') is-invalid @enderror"
                                    name="anggota_3" value="{{ old('anggota_3', $pemeriksaan->anggota_3) }}">
                                @error('anggota_3')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
