...
@section('content')
    <div class="container-fluid">
        ...
        <form id="form" action="{{ route('surat-ketetapan-pajak.store') }}" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_skp') is-invalid @enderror"
                                name="nomor_skp" value="{{ old('nomor_skp') }}">
                            @error('nomor_skp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_skp') is-invalid @enderror"
                                name="tanggal_skp" value="{{ old('tanggal_skp') }}">
                            @error('tanggal_skp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_lhp') is-invalid @enderror"
                                name="nomor_lhp" value="{{ old('nomor_lhp') }}">
                            @error('nomor_lhp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_lhp') is-invalid @enderror"
                                name="tanggal_lhp" value="{{ old('tanggal_lhp') }}">
                            @error('tanggal_lhp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control @error('nominal_terbit') is-invalid @enderror"
                                name="nominal_terbit" value="{{ old('nominal_terbit') }}">
